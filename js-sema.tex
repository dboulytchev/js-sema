...
keywords={function, if, else, return, var, true, this},
sensitive=true,
...
properties, but these details are not essential for now. Each property posesses a \emph{key} which in fact can be a \emph{symbol}
